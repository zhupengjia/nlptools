...
class BytePair(Vocab):
    ...
    def __init__(self, bpe_size=1000, min_freq=2, separator='@@', code_file='', **args):
        '''
            Byte Pair Encoding (BPE) vocabulary for rare word, see https://arxiv.org/abs/1508.07909. Only used for latin languages. Note the bpe vocab is included in total vocab
